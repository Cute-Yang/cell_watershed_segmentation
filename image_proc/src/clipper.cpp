...
OutPt* Clipper::AddLocalMinPoly(TEdge* e1, TEdge* e2, const IntPoint& Pt) {
    ...
    if (prevE && prevE->OutIdx >= 0 && prevE->Top.Y < Pt.Y && e->Top.Y < Pt.Y) {
        ...
        if (xPrev == xE && (e->WindDelta != 0) && (prevE->WindDelta != 0) &&
            SlopesEqual(
                IntPoint(xPrev, Pt.Y), prevE->Top, IntPoint(xE, Pt.Y), e->Top, m_UseFullRange)) {
...
void Clipper::InsertLocalMinimaIntoAEL(const cInt botY) {
    ...
    while (PopLocalMinima(botY, lm)) {
        ...
        if (lb->OutIdx >= 0 && lb->PrevInAEL && lb->PrevInAEL->Curr.X == lb->Bot.X &&
            ...
            SlopesEqual(
                lb->PrevInAEL->Bot, lb->PrevInAEL->Top, lb->Curr, lb->Top, m_UseFullRange) &&
        ...
        if (lb->NextInAEL != rb) {
            ...
            if (rb->OutIdx >= 0 && rb->PrevInAEL->OutIdx >= 0 &&
                SlopesEqual(
                    rb->PrevInAEL->Curr, rb->PrevInAEL->Top, rb->Curr, rb->Top, m_UseFullRange) &&
